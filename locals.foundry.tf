locals {
  ...
  foundry_ai_foundry = merge(
    var.ai_foundry_definition.ai_foundry, {
      ...
      private_endpoints_manage_dns_zone_group = var.private_dns_zones.azure_policy_pe_zone_linking_enabled ? false : try(var.ai_foundry_definition.ai_foundry.private_endpoints_manage_dns_zone_group, true)
    }
  )
  foundry_ai_search_definition = { for key, value in var.ai_foundry_definition.ai_search_definition : key => merge(
    var.ai_foundry_definition.ai_search_definition[key], {
      ...
      private_endpoints_manage_dns_zone_group = var.private_dns_zones.azure_policy_pe_zone_linking_enabled ? false : try(var.ai_foundry_definition.ai_search_definition[key].private_endpoints_manage_dns_zone_group, true)
    }
  ) }
  foundry_cosmosdb_definition = { for key, value in var.ai_foundry_definition.cosmosdb_definition : key => merge(
    var.ai_foundry_definition.cosmosdb_definition[key], {
      ...
      private_endpoints_manage_dns_zone_group = var.private_dns_zones.azure_policy_pe_zone_linking_enabled ? false : try(var.ai_foundry_definition.cosmosdb_definition[key].private_endpoints_manage_dns_zone_group, true)
    }
  ) }
  ...
  foundry_key_vault_definition = { for key, value in var.ai_foundry_definition.key_vault_definition : key => merge(
    var.ai_foundry_definition.key_vault_definition[key], {
      ...
      private_endpoints_manage_dns_zone_group = var.private_dns_zones.azure_policy_pe_zone_linking_enabled ? false : try(var.ai_foundry_definition.key_vault_definition[key].private_endpoints_manage_dns_zone_group, true)
    }
  ) }
    ...
    var.ai_foundry_definition.storage_account_definition[key], {
      endpoints = {
        ...
        ek => {
          ...
          private_endpoints_manage_dns_zone_group = var.private_dns_zones.azure_policy_pe_zone_linking_enabled ? false : try(var.ai_foundry_definition.storage_account_definition[key].endpoints[ek].private_endpoints_manage_dns_zone_group, true)
          type                                    = lower(ek)
        }
      }
    }
